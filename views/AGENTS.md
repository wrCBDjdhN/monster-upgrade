...
**Updated:** 2026-08-17 | **Files:** 13 | **Lines:** ~6,061
...
| 主游戏视图（**最大,2553 行**） | game_view.py | HUD、世界/屏幕坐标标签、实体生成编排、委托 game/ 层 |
...
| 角色选择界面（4 角色/技能/经验升级永久加成） | character_select_view.py | 角色选择 UI：4 角色展示、技能说明、经验升级永久加成 |
