...
HELMETS = {
    ...
    "space_helmet": {
        "name": "航天头盔",
        "defense": 12,  # 略高于板甲(12)，低于强相互作用力头盔(32)
    ...
    "strong_force_helm": {
        "name": "强相互作用力头盔",
        "defense": 32,  # 平衡调整：原60，降低避免几乎不死（常规最高航天头盔12）
    ...
    "holy_crown": {
        "name": "圣光冠冕",
        "defense": 44,  # 平衡调整：原80（强相互作用力头盔32上位版）
        "price": 0,
...
ARMORS = {
    ...
    "space_armor": {
        "name": "航天护甲",
        "defense": 18,  # 高于木乃伊护甲(15)，低于强相互作用力护甲(55)
    ...
    "strong_force_armor": {
        "name": "强相互作用力护甲",
        "defense": 55,  # 平衡调整：原100（常规最高航天护甲18）
        "price": 0,  # 价格为0：不可在市场购买，仅锻造获得
        "color": (200, 200, 255),
    ...
    "dragon_scale_armor": {
        "name": "龙鳞战甲",
        "defense": 68,  # 平衡调整：原130（强相互作用力护甲55上位版）
        "price": 0,
